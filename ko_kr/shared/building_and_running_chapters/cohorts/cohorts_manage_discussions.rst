...
학습 집단 기능이 활성화된 강좌에서, 모든 게시글에는 읽기 권한에 관한 안내를 확인할 수 있다. 이는 학습자가 학습 집단 기능이 활성화된 강좌와 아닌 강좌에서 토의할 때 인지하게 되는 유일한 차이점이다. 게시글의 :ref:`Read the Cohort Indicator in Posts` 와 :ref:`Discussions for Students and Staff` 에서 게시글 공개 설정에 대한 예시를 확인할 수 있다.
