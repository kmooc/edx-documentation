...
* `구글 캘린더 활용하기`_
  ...
  * `강좌 내용에 구글 캘린더 추가하기`_
    ...
    * `edX 스튜디오에서 구글 캘린더 구성 요소 추가하기`_
...
.. 참고:: 
  EdX 학습 관리 시스템은 구글 캘린더에 대한 높이 및 너비 값을 설정한다. 이러한 속성을 추가 하면, LMS는 변경 내용을 무시한다.
