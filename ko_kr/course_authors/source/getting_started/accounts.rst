...
.. note:: Edge와 kmooc.org는 강좌 데이터와 계정이 별도로 운영된다. 따라서 K-MOOC 교수자 및 강좌 운영팀이 kmooc.org와 Edge를 모두 이용하려면, 두 사이트에 각각 등록해야 한다.
...
#. kmooc.org의 경우, `등록 및 로그인 페이지
   ...
   Edge의 경우, `등록 및 로그인 페이지 <http://edx.kotech.biz/register?next=%2Fdashboard>`_ 로 이동한다.
...
edX는 교수자 및 강좌 운영팀이 K-MOOC 강좌를 수강하거나 만드는 방법을 익힐 수 있도록 데모강좌와 edX101을 제공한다.
...
* edX101_ 은 Studio로 개발된 강좌의 예이다. 스스로 온라인 강좌를 계획하고, 개발하고, 운영하는 것에 관해 진도에 맞춰 배울 수 있다.
